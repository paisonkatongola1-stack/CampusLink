...
function App() {
  return (
    <AuthProvider>
      <BrowserRouter>
        <ScrollToTop />
        <div className="min-h-screen bg-white dark:bg-[#0A0B14] text-surface dark:text-white selection:bg-primary/30 overflow-x-hidden font-sans text-xs transition-colors duration-300">
          <Navbar />
          <div className="pt-20">
