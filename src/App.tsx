...
function App() {
  return (
    <AuthProvider>
      <BrowserRouter>
        <ScrollToTop />
        <div className="min-h-screen bg-white dark:bg-[#0A0B14] text-gray-900 dark:text-white transition-colors duration-300 selection:bg-primary/30 overflow-x-hidden font-sans text-xs">
          <Navbar />
          <div className="pt-20">
