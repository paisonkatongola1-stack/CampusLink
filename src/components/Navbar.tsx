  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 glass border-b border-white/5 px-6 py-4 shadow-2xl">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        <Link to="/" className="text-2xl font-black text-[#0A0B14] dark:text-white tracking-tighter italic flex items-center">
        ...
        <div className="hidden lg:flex space-x-6 items-center font-bold">
          ...
          <div className="flex items-center space-x-4">
            ...
            {user ? (
              <div className="flex items-center space-x-4">
                <Link to="/chat" className="text-gray-400 hover:text-primary transition-colors flex items-center space-x-1 group">
                  <Sparkles size={18} strokeWidth={2.5} className="group-hover:animate-pulse" />
                  <span className="text-[10px] uppercase tracking-widest hidden xl:inline font-black">AI Assistant</span>
                </Link>
